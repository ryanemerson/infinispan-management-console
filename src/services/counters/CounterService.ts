...
export class CounterService {
  ...
  public static STRONG_COUNTER: string = "STRONG";
  public static WEAK_COUNTER: string = "WEAK";
  public static COUNTER_TYPES: string [] = ["STRONG", "WEAK"];
  public static COUNTER_STORAGE_TYPES: string [] = ["PERSISTENT", "VOLATILE"];
